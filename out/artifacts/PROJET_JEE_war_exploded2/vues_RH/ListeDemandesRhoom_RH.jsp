...
<%@page import="java.util.List,fr.gestconge.classes.beans.Demande"%>
...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-primary " style="background-image: linear-gradient(60deg, rgb(0, 188, 212), rgb(142, 36, 170));">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="${pageContext.request.contextPath}/assets/img/attente.png" alt="En cours" id = statut style="height: 25px" ; width="25px"/>
                                        <script>
                                            if((<%=statut %>) === 0) {
                                    ...
                                    <td class="action">
                                        <a href="<c:url value="/SuppressionServlet"><c:param name="dtCreation" value="${ mapDemandes.key }" /></c:url>">
                                            <img src="${pageContext.request.contextPath}/assets/img/valider.png" alt="Supprimer" style="height: 25px" ; width="25px"/>
                                        </a>
                                        <a href="<c:url value="/ModificationServlet"><c:param name="dtCreation" value="${ mapDemandes.key }" /></c:url>">
                                            <img src="${pageContext.request.contextPath}/assets/img/refuser.png" alt="Modifier" style="height: 25px" ; width="25px"/>
                                        </a>
                                    </td>
