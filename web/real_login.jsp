            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="input-group form-group">
                        ...
                        <input type="email" class="form-control" placeholder="email" value="<%--@elvariable id="utilisateur" type="fr.gestconge.classes.beans.Employe"--%>
                ...
                <div class="card-footer">
                    <div class="d-flex justify-content-center links">
                        Don't have an account?<a href="InscriptionServlet">Sign Up</a>
                    </div>
