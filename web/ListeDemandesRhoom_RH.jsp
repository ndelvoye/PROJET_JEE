                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="assets/img/attente.png" alt="En cours"  id = statut style="height: 25px"; width="25px"/>
                                        <script>
                                            if((<%=statut %>) === 0) {
                                                document.getElementById('statut').src = 'assets/img/attente.png';
                                            }
                                            else if ((<%=statut %>) === 1) {
                                                document.getElementById('statut').src = 'assets/img/valider.png';
                                            }
                                            else if ((<%=statut %>) === -1) {
                                                document.getElementById('statut').src = 'assets/img/refuser.png';
                                            }
                                        </script>
