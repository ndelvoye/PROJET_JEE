                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" required="required" class="form-control" placeholder="Nom"
                               name="nom_demandeur" value="${old.nomDemandeur}" size="30" maxlength="30"/>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" required="required" class="form-control" placeholder="Prenom"
                               name="prenom_demandeur" value="${old.prenomDemandeur}" size="30" maxlength="30"/>
