            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="input-group form-group">
                        ...
                        <input type="email" id="email" name="email" class="form-control" placeholder="email" value="<%--@elvariable id="utilisateur" type="fr.gestconge.classes.beans.Employe"--%>
                    ...
                    <div class="input-group form-group">
                        ...
                        <input type="password" id="motdepasse" name="motdepasse" class="form-control" placeholder="mot de passe" value="<c:out value="${utilisateur.motDePasse}"/>"  size="20" maxlength="20" />
